...
// func TestVerifyPoof(t *testing.T) {
// 	proof := [][]byte{}
// 	root := []byte{}
// 	path := []byte{}
// 	var proofStruct EIP1186ProofResponse
// 	err := json.Unmarshal(proof, &proofStruct) 
// 	value, err := EncodeAccount() 

	

// 	isValid, err := VerifyProof(proof, root, path, value)
